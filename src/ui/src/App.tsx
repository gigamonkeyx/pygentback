...
import StartupOrchestrationPage from '@/pages/StartupOrchestrationPage';
import StartupConfigurationPage from '@/pages/StartupConfigurationPage';
import StartupMonitoringPage from '@/pages/StartupMonitoringPage';
...
const ViewRouter: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/startup/orchestration" element={<StartupOrchestrationPage />} />
      <Route path="/startup/configuration" element={<StartupConfigurationPage />} />
      <Route path="/startup/monitoring" element={<StartupMonitoringPage />} />
