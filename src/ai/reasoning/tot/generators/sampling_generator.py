...
Continue the reasoning process by exploring a new direction or deepening the current approach. Be diverse in your thinking.
...
Generate a creative continuation or alternative perspective on this thought.
...
New thought:"""
    ...
    def _determine_thought_type(self, parent_thought: Thought, content: str) -> ThoughtType:
        ...
        elif "solution" in content.lower() or "answer" in content.lower():
