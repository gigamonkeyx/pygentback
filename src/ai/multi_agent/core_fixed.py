...
class CommunicationHub:
    ...
    async def get_messages(self, filter_criteria: Optional[Dict[str, Any]] = None, limit: Optional[int] = None) -> List[Message]:
        """Get messages with optional filtering"""
        try:
            if filter_criteria:
                messages = self.filter_messages(filter_criteria)
            else:
    ...
    async def _execute_workflow_steps(self, workflow: Workflow) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'step_results': step_results  # Add this for test compatibility
            }
        except Exception as e:
            return {'success': False, 'error': str(e)}
    ...
    async def register_agent(self, agent_or_config):
        ...
        if isinstance(agent_or_config, dict):
            ...
            agent = Agent(
                ...
                config=agent_or_config.get('configuration', {}),
